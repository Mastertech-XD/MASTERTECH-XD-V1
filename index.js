...
const DOWNLOAD_URL = 'https://github.com/Mastertech-XD/MASTERTECH-XD V2/archive/refs/heads/main.zip';
const EXTRACT_DIR = path.join(TEMP_DIR, 'MASTERTECH-XD V2-main');
